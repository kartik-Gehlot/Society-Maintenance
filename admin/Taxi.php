                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <form action="action.php" method="POST"  enctype="multipart/form-data">
                            <h3 class="text-center ">Add Taxi</h3>

                            <div class="mb-3 mt-4 ms-3 me-3">
                                <label for="text" class="form-label  mb-2">Name:</label>
                            ...
                            <!-- <div class="mb-3 mt-4 ms-3 me-3">
                                <label for="Seats" class="mb-2">Add seats:</label>
                                <input type="number" class="form-control" name="seat" required>
                            </div> -->
                            <div class="mb-3 mt-4 ms-3 me-3 text-center">
                                <input type="submit" class=" btn btn-info" name="Taxi" value="Upload">
                            </div>
                        </form>
                    </div>
                    <div class="col-sm-4"></div>
